...
## Environments
- Preview: https://main--iwmaster-amneal--aemysites.aem.page/
- Live: https://main--iwmaster-amneal--aemysites.aem.live/
...
1. Open the `iwmaster-amneal` directory in your favorite IDE and start coding :)
